...
public class RecordView extends View {
    ...
    private void init() {
        ...
        downColor = R.color.colorPrimary;
        upColor = R.color.white;

        paint = new Paint();
        paint.setAntiAlias(true);//抗锯齿
        paint.setStyle(Paint.Style.STROKE);//画笔属性是空心圆
        currentStrokeWidth = getResources().getDimension(R.dimen.record_view_stroke_width);
        paint.setStrokeWidth(currentStrokeWidth);//设置画笔粗细

        slideDis = getResources().getDimension(R.dimen.record_view_stroke_width);
        radiusDis = getResources().getDimension(R.dimen.record_view_radius);
        strokeWidthDis =  getResources().getDimension(R.dimen.record_view_stroke_size)/4;
